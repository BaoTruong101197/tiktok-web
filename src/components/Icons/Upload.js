export const CheckIcon = ({ className, width = '12px', height = '9.6px', color = 'none' }) => (
    <svg
        viewBox="0 0 10 8"
        className={className}
        width={width}
...
export const DropDownIcon = ({ className, width = '30px', height = '30px', color = '#B0B0B4' }) => (
    <svg
        viewBox="0 0 48 48"
        className={className}
        width={width}
...
export const ArrowUpIcon = ({ className, width = '14px', height = '14px', color = 'currentColor' }) => (
    <svg
        viewBox="0 0 48 48"
        className={className}
        width={width}
